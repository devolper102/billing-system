      ...
      <div class="menu_inner">
        ...
        <div class="main_logo_outer">
          ...
          <div class="nextPrev_btns">
            <a style="display: {{$showArrow}} !important;" class="prev_btn" href="{{route('client_list.show', Hashids::encode($client->id))}}" ></a>
            <a style="display: {{$backArrow}} !important;" class="next_btn" href="{{route('client.edit', Hashids::encode($client->id))}}" ></a>
          </div>
        </div>
