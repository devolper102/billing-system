                                ...
                                <div class="menu_box_table">
                                    <div class="tableCell width60">
                                        <div class="dashboard_text">
                                            <strong>{{$bill->name }} - {{$bill->total}} euros:</strong>
                            ...
                            <div class="profile_box">
                                <div class="menu_box_table">
                                    ...
                                    <div class="tableCell">
                                        ...
                                        <div class="dashboard_switch">
                                            <div class="onoff_switch disabled_class">
                                                <a  data-id="{{$bill->id}}" data-type="{{$bill->status}}" class="update_bill_status active" href="javascript:void(0);"></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
