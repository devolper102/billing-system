                        ...
                        <div class="menu_box_table addquote_btns_main">
                            <div class="profile_box_tableCell">
                                <div class="addquote_sendBtn">
                                    <input type="submit" data-status="update" data-type="{{$quote_type}}" value="Save" class="quote_cal_save_btn">
                                </div>
                            </div>
                            <div class="profile_box_tableCell">
                                <div class="addquote_sendBtn">
                                    <input type="submit" data-status="update" data-type="{{$quote_type}}" value="Envoyer Devis" data-email="{{$client->email}}" data-id="{{$client->id}}" class="send_quote_in_email_btn">
                                </div>
                            </div>
                        </div>
                    </div>
