                                ...
                                <div class="menu_box_table">
                                    <div class="profile_box_tableCell width40">
                                        <div class="preview_btn">
                                            <a href="javascript:void(0)" class="qt_preview_non_client_btn">Preview</a>
                                        </div>
                                    </div>
                                    <div class="profile_box_tableCell width60">
                                        <div class="profile_box">
                                ...
                                <div class="profile_box">
                                    <div class="menu_box_table">
                                        ...
                                        <div class="profile_box_tableCell">
                                            <div class="profile_edit_feildOut">
                                                <div class="profile_edit_feild">
                                                    <input type="text" class="qt_concern_text" value="Chaudiere">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                                    ...
                                                    <div class="profile_box">
                                                        <div class="menu_box_table">
                                                            ...
                                                            <div class="profile_box_tableCell">
                                                                <div class="profile_edit_feildOut">
                                                                    <div class="profile_edit_feild">
                                                                        <input type="text" value="2"  class=" calculate_ quote_quantity">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="profile_box">
                                                        <div class="menu_box_table">
                                                            ...
                                                            <div class="profile_box_tableCell">
                                                                <div class="profile_edit_feildOut">
                                                                    <div class="profile_edit_feild">
                                                                        <input type="text" name="quote_price" class="quote_price" value="15.80">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                        ...
                                        <div class="menu_box_table addquote_btns_main">
                                            <div class="profile_box_tableCell">
                                                <div class="addquote_sendBtn">
                                                    <input type="submit" value="Save" class="qt_add_quote_non_client_btn">
                                                </div>
                                            </div>
                                            <div class="profile_box_tableCell">
                                                <div class="addquote_sendBtn">
                                                    <input type="submit" value="Envoyer Devis" data-email="" data-id="" class="send_quote_in_email_btn">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
