      ...
      <div class="menu_inner">
        ...
        <div class="main_logo_outer">
          ...
          <div class="nextPrev_btns">
            @if(request()->q == 'view')
              <a style="display: block !important;" class="prev_btn" href="{{Request::url()}}?q=edit"></a>
              @elseif(request()->q == 'edit')
              <a style="display: block !important;" class="next_btn" href="{{Request::url()}}?q=view"></a>
            @endif
            ...
            <div class="menu_box_table">
              ...
              <div class="profile_box_tableCell width33">
                <div class="addNewQuote_head_text text_center ">
                  <p><b>Facture</b>No. <span class="qt_random_quote_number">{{$quote->document_number}}</span></p>
                </div>
              </div>
              <div class="profile_box_tableCell width33">
                ...
                <div class="menu_box_table">
                  <div class="profile_box_tableCell width40">
                    <div class="preview_btn">
                      <a href="javascript:void(0)" class="qt_pre_draft_bill_preview_btn">Preview</a>
                    </div>
                  </div>
                          ...
                          <div class="menu_box_table addquote_btns_main">
                              <div class="profile_box_tableCell">
                                  <div class="addquote_sendBtn">
                                      <input type="submit" data-status="update" data-type="bill"  value="Save" class="quote_cal_save_btn update_bill_btn">
                                  </div>
                              </div>
                              <div class="profile_box_tableCell">
                                  <div class="addquote_sendBtn">
                                      <input type="submit" data-status="update" data-type="bill"  value="Envoyer Devis" data-email="{{$quote->client->email}}" data-id="{{$quote->client->id}}" class="send_bill_emai_btn update_bill_btn">
                                  </div>
                              </div>
                          </div>
                      </div>
